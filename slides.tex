...
\begin{frame}{Q6: Feature Importance (Permutation)}
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{./images/Q6_diagrams/q6_top5_features.png}
  \end{figure}
...
\begin{frame}{Q8: Unsupervised k-means in PCA Space}
  \begin{block}{Approach}
    \begin{itemize}
      \item Apply PCA (5 components) on TRAIN
  ...
  \begin{alertblock}{Result}
    \textbf{Lower accuracy than supervised methods.}
...
\begin{frame}{Performance Comparison}
  \begin{table}
    ...
    \begin{tabular}{lc}
      ...
      PCA + k-means          & \textcolor{red}{Lower} \\
      \bottomrule
    \end{tabular}
  \end{table}
  ...
  \textbf{Ranking:} SVM $\approx$ MLP $>$ Bayes $>$ Linear $>$ k-means
\end{frame}
...
\begin{frame}{Key Findings}
  \begin{enumerate}
    ...
    \item \textbf{Unsupervised falls short:} k-means cannot match supervised performance
  \end{enumerate}
\end{frame}
...
\begin{frame}{Limitations \& Future Work}
  \begin{block}{Limitations}
    \begin{itemize}
      \item Limited to provided features (no time series, network analysis)
      \item Imbalanced classes (killers 3, 6, 7 dominate)
      \item No ensemble methods explored
    \end{itemize}
  \end{block}
  ...
  \begin{block}{Future Directions}
    \begin{itemize}
      \item Ensemble models (voting, stacking)
      \item Deep learning (CNN, attention mechanisms)
      \item External data (social networks, historical patterns)
...
\begin{frame}[plain]
  \begin{center}
    ...
    Βασίλαινα Μαρία, Γρηγοράσκου Τερέζα, Λιβέρης Φώτης
